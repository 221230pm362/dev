...
INSERT INTO PRODUCT(PNAME,CNT) VALUES('갤럭시23' , 100);
INSERT INTO PRODUCT(PNAME,CNT) VALUES('아이폰14' , 100);

CREATE TRIGGER TRG_P_ORDER
AFTER INSERT ON P_ORDER
BEGIN
    UPDATE PRODUCT SET CNT = CNT-1 WHERE PNAME = '갤럭시23';
END;
/

INSERT INTO P_ORDER(PNAME, PCNT) VALUES('갤럭시23' , 1);
