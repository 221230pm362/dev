...
CREATE TABLE MEMBER(
    ...
    , HOBBY         VARCHAR2(100)
    , STATUS        CHAR(1)       DEFAULT 'O' CHECK (STATUS IN ('O', 'X', 'S'))
...
ALTER TABLE NOTICE_REPLY ADD CONSTRAINT FK_NOTICE_REPLY_BOARD FOREIGN KEY (NOTICE_NO) REFERENCES NOTICE(NO);
...
--샘플 데이터 (BOARD)
INSERT INTO BOARD(NO,TITLE,CONTENT,WRITER_NO,CATEGORY_NO) VALUES (SEQ_BOARD_NO.NEXTVAL,'제목01','내용01',1,10);
INSERT INTO BOARD(NO,TITLE,CONTENT,WRITER_NO,CATEGORY_NO) VALUES (SEQ_BOARD_NO.NEXTVAL,'제목02','내용02',1,20);
INSERT INTO BOARD(NO,TITLE,CONTENT,WRITER_NO,CATEGORY_NO) VALUES (SEQ_BOARD_NO.NEXTVAL,'제목03','내용03',1,30);
COMMIT;
